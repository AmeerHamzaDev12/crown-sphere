...
export const heroStats = [
  { value: "8", label: "Ventures and platforms across the ecosystem" },
  { value: "1M", label: "Verified women targeted by Aurat Card" },
  { value: "9", label: "Partner sectors, from healthcare to retail" },
